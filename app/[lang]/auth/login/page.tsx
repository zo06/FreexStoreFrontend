        ...
        <div className="w-full max-w-sm sm:max-w-md">
          <div className="animate-element bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
            ...
            <div className="animate-element text-center mb-6 sm:mb-8">
              <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">{t('welcomeBack')}</h1>
              <p className="text-slate-400 text-xs sm:text-sm">{t('signInToAccess')}</p>
            </div>
          ...
          <div className="text-center">
            <div className="mb-6 sm:mb-8">
              ...
              <p className="animate-element text-slate-400 max-w-sm sm:max-w-md mx-auto leading-relaxed text-sm sm:text-base px-4 sm:px-0">
                {t('accessYourLicensed')}
              </p>
              
              {/* New User Prompt */}
              <div className="animate-element mt-6 bg-gradient-to-r from-emerald-500/10 to-green-500/10 border border-emerald-500/20 rounded-xl p-4">
                <p className="text-slate-300 text-sm">{t('newHereGetTrial')}</p>
              </div>
            </div>
          </div>
        </div>
