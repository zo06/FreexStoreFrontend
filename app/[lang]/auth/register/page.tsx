        ...
        <div className="w-full max-w-sm sm:max-w-md">
          <div className="animate-element bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-700/50">
            ...
            <div className="animate-element text-center mb-6 sm:mb-8">
              <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">{t('createAccount')}</h1>
              <p className="text-slate-400 text-xs sm:text-sm">{t('joinAndStart')}</p>
            </div>
            ...
            <div className="animate-element mb-6 sm:mb-8">
              <div className="bg-gradient-to-r from-emerald-500/20 to-green-500/20 border border-emerald-500/30 rounded-xl p-4">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-emerald-400 font-semibold text-sm">{t('freeTrialIncluded')}</span>
                </div>
                <p className="text-slate-300 text-xs text-center">{t('freeTrialDetails')}</p>
              </div>
            </div>
            ...
            >
              ...
              <span className="text-sm sm:text-base">{t('signUpWithDiscord')}</span>
            </button>
        ...
        <div className="relative h-full flex items-center justify-center p-4 sm:p-6 lg:p-8">
          <div className="text-center">
            <div className="mb-6 sm:mb-8">
              ...
              <h2 className="animate-element text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">{t('fivemScriptsStore')}</h2>
              <h3 className="animate-element text-lg sm:text-xl lg:text-2xl font-light text-slate-300 mb-4 sm:mb-6">{t('nuiScriptsAndUi')}</h3>
              ...
              <div className="animate-element mt-6 space-y-3">
                <div className="flex items-center justify-center gap-2 text-slate-300 text-sm">
                  ...
                  <span>{t('threeDayFreeTrial')}</span>
                </div>
                <div className="flex items-center justify-center gap-2 text-slate-300 text-sm">
                  <svg className="w-4 h-4 text-emerald-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>{t('accessUpToScripts')}</span>
                </div>
                <div className="flex items-center justify-center gap-2 text-slate-300 text-sm">
                  <svg className="w-4 h-4 text-emerald-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
