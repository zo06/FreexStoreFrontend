            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="text-start py-3 px-4 text-gray-300 font-semibold">Script Name</th>
                  <th className="text-end py-3 px-4 text-gray-300 font-semibold">Sales Count</th>
                  <th className="text-end py-3 px-4 text-gray-300 font-semibold">Revenue</th>
                  <th className="text-end py-3 px-4 text-gray-300 font-semibold">Avg Price</th>
                </tr>
              </thead>
              <tbody>
                {scriptSalesData.length > 0 ? (
                  scriptSalesData.map((script, index) => (
                    <tr key={index} className="border-b border-gray-800 hover:bg-gray-800/50">
                      ...
                      <td className="py-3 px-4 text-end text-blue-400">{script.sales}</td>
                      <td className="py-3 px-4 text-end text-green-400">{formatCurrency(script.revenue)}</td>
                      <td className="py-3 px-4 text-end text-purple-400">
