...
function AdminDashboard() {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-cyan-900/30 via-blue-900/20 to-emerald-900/30">
        <div className="text-center">
          <div className="w-32 h-32 mx-auto rounded-full border-b-2 animate-spin border-cyan-400"></div>
          <p className="mt-4 text-white text-lg">{t('dashboardSection.loadingAnalytics')}</p>
        </div>
      </div>
    )
  }
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-cyan-900/30 via-blue-900/20 to-emerald-900/30">
        <div className="text-center p-8 bg-red-900/40 rounded-2xl border border-red-500/30 backdrop-blur-xl max-w-lg">
              ...
              <div key={index} className="overflow-hidden relative p-6 bg-gradient-to-br rounded-2xl border backdrop-blur-sm transition-all duration-500 group from-cyan-900/40 to-purple-800/20 border-cyan-500/20 sm:p-8 hover:border-cyan-400/40 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-2">
                    <div className={`w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br ${stat.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
