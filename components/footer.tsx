...
import { Zap, Mail, MessageCircle, Github, Twitter, ExternalLink, Heart, Sparkles, TrendingUp, Gift, User, LayoutDashboard, Key } from 'lucide-react';
...
export default function Footer() {
  ...
  const scriptLinks = [
    { name: 'All Scripts', href: '/scripts', icon: Sparkles },
    { name: 'Popular', href: '/scripts?filter=popular', icon: TrendingUp },
    { name: 'New Releases', href: '/scripts?filter=new', icon: Zap },
    { name: 'Free Trials', href: '/scripts?filter=trial', icon: Gift },
  ...
  const accountLinks = isAuthenticated 
    ? [
        ...
        { name: 'My Licenses', href: '/dashboard', icon: Key },
      ]
    : [
  ...
  const legalLinks = [
    { name: 'Terms of Service', href: '/auth/terms' },
    { name: 'Privacy Policy', href: '/auth/privacy' },
    { name: 'Refund Policy', href: '/auth/refund' },
    { name: 'License Agreement', href: '/auth/license' },
  ];
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-6 lg:mb-0">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6 max-w-xs">
              Premium FiveM NUI scripts and resources. Modern menus, HUDs, shops, and UI systems with secure licensing.
            </p>
          ...
          <nav className="col-span-1" aria-label="Scripts navigation">
            <h3 className="text-white font-semibold mb-4 text-sm uppercase tracking-wider">Scripts</h3>
        ...
        <div className="border-t border-white/5 pt-8 mb-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-400 text-sm">Contact our support team or join our Discord community.</p>
            </div>
            <div className="flex items-center gap-3">
              <Link href="/contact">
        ...
        <div className="border-t border-white/5 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            {/* Copyright */}
            <p className="text-gray-500 text-sm text-center md:text-left" itemProp="copyrightNotice">
              © {currentYear} <span itemProp="copyrightHolder">FreexStore</span>. All rights reserved.
            </p>
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <span className="text-gray-500">
                Made with <Heart className="w-4 h-4 inline text-red-400" /> for FiveM
              </span>
            </div>
          </div>
        </div>
